...
OUTPUT_NAME="input_data_all_sliding_windows.csv"
...
DataGenerator.data_generator('all_sliding_windows_config.ini')
PY

mkdir -p "$BACKEND_RESOURCES_DIR"
cp "$GENERATOR_DIR/$OUTPUT_NAME" "$BACKEND_OUTPUT_FILE"

echo "All-scale sliding-windows input generated:"
