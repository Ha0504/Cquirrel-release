...
OUTPUT_NAME="input_data_1pct_sliding_windows.csv"
...
DataGenerator.data_generator('one_percent_sliding_windows_config.ini')
PY

mkdir -p "$BACKEND_RESOURCES_DIR"
cp "$GENERATOR_DIR/$OUTPUT_NAME" "$BACKEND_OUTPUT_FILE"

echo "1% sliding-windows input generated:"
