        ...
        return (
            <div className="codegen-card">
                <Card title="Codegen Log: " extra={
                    <div>
                        <Button size="small" type="link" icon={<DownloadOutlined />} href={`${BACKEND_ORIGIN}/r/download_codegen_log`}> Download Codegen Log</Button>
                        <Button size="small" type="link" icon={<DownloadOutlined />} href={`${BACKEND_ORIGIN}/r/download_generated_jar`}> Download Generated Jar</Button>
                    </div>}
                >
